        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Turn your social posts into SEO-optimized blog articles with AI
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/changelog" className="text-muted-foreground hover:text-primary">Changelog</Link></li>
            </ul>
          </div>
