...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-violet-500/10 rounded-full blur-3xl -z-10" />
      
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8 md:space-y-10">
          <div className="space-y-4 max-w-4xl mx-auto">
            <div className="inline-flex items-center rounded-full border border-border bg-background px-4 py-1.5 mb-4 text-sm font-medium text-foreground">
            ...
            <h1 
              className={`text-4xl md:text-5xl lg:text-7xl font-heading font-bold tracking-tight bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent
                ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
              style={{animationDelay: '100ms'}}
            >
              Turn Social Posts into <span className="text-gradient">SEO Blogs</span> - Automatically
            </h1>
          ...
          >
            <div className="absolute -inset-1.5 bg-gradient-to-r from-primary/20 to-violet-500/20 rounded-2xl blur-lg opacity-70 group-hover:opacity-100 transition duration-300"></div>
            <div className="relative bg-card rounded-xl overflow-hidden border border-border shadow-xl">
              ...
              <div className="grid md:grid-cols-2 gap-6 p-6 bg-card">
                <div className="flex flex-col">
                  <div className="flex items-start gap-3 mb-4 p-4 rounded-lg bg-muted">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm">
                        Just shared my thoughts on how AI is revolutionizing content creation. The ability to instantly convert ideas into polished content is a game-changer for creators who want to focus on strategy rather than execution. #ContentCreation #AI
                      </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm">
                        Excited to announce our latest research on AI and content strategy! We've found that companies leveraging AI for content repurposing see a 3x increase in output with 40% less time investment. #ContentStrategy #AI
                      </div>
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                ...
                <div className="border-l border-border pl-6 flex flex-col">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-xs text-primary font-medium">SEO Score: 92/100</div>
                    </div>
